    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
            ...
            <Card className="p-8 border-0 shadow-sm rounded-3xl bg-white">
              ...
              <div className="space-y-4">
                {winnings.map((winning) => (
                  <div key={winning.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-5 rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-gray-50/50 group">
        ...
        <div className="space-y-8">
            ...
            <Card className="p-6 bg-gradient-to-br from-[#145A41] to-[#0B3D2E] text-white rounded-3xl shadow-lg border-0 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10 mb-4">
                  <div className="text-xs font-bold text-white/60 uppercase tracking-wider mb-1">Selected Cause</div>
                  <div className="text-lg font-bold text-white">Children's Education Fund</div>
          ...
          {/* Upcoming Draw */}
          <motion.div initial={{ x: 20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.7, duration: 0.6 }}>
            <Card className="p-6 border-0 shadow-sm rounded-3xl bg-white">
              <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
